...
module.exports = {
  ...
  componentIndexJs: resolveApp('src/index.js'),
  devIndexJs: resolveApp('demo/index.js'),
...
if (!reactScriptsLinked && __dirname.indexOf(path.join('packages', 'react-scripts', 'config')) !== -1) {
  module.exports = {
    ...
    componentIndexJs: resolveApp('template/src/index.js'),
    devIndexJs: resolveApp('template/demo/index.js'),
    appPackageJson: resolveOwn('package.json'),
    appSrc: [resolveOwn('template/src'), resolveOwn('template/demo')],
